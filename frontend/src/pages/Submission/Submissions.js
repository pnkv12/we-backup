...
const Submissions = () => {
    ...
    const downloadCSV = async (submissionId) => {
        window.location.replace(`http://localhost:8000/v1.0/csv/download/${submissionId}`);
            await axios.get(`http://localhost:8000/v1.0/csv/download/${submissionId}`);
    }
                                        ...
                                        <>
                                            ...
                                            <Box sx={{display: "flex"}} fullWidth>
                                                <Box sx={{display: "flex", alignItems: "center"}}>
                                                    ...
                                                    <Typography>Closure date: {submission.closure_date}</Typography>
                                                </Box>
                                            </Box>
                                            <Box sx={{display: "flex"}} fullWidth>
                                                <Box sx={{display: "flex", alignItems: "center"}}>
                                                    ...
                                                    <Typography>Final closure date: {submission.final_closure_date}</Typography>
                                                </Box>
                                            </Box>
                                            <Box sx={{display: "flex"}} fullWidth>
                                                <Box sx={{display: "flex", alignItems: "center"}}>
                                                    <IconButton
                                                        ...
                                                        aria-label="comments"
                                                        component="span"
                                                        onClick={async()=>{ await downloadCSV(submission._id)}}
                                                    >
                                                        <CloudDownloadIcon/>
                                                    </IconButton>

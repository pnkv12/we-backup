...
const IdeaDetails = () => {
    ...
    useEffect(() => {
        setTimeout(() => {
            fetch("http://localhost:8000/v1.0/idea/" + id)
                .then((res) => {
                    if (!res.ok) {
    ...
    useEffect(() => {
        axios.post(`http://localhost:8000/v1.0/view`, {'user_id': uid, 'idea_id': id}).then((r) => {
        });
    }, []);
    ...
    useEffect(() => {
        axios
            .get("http://localhost:8000/v1.0/idea/" + id)
            .then((res) => {
    ...
    function submit(e) {
        e.preventDefault();
        axios
            .patch(`http://localhost:8000/v1.0/idea/${id}`, data)
            .then((res) => {

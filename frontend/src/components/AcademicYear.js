...
const AcademicYear = () => {
    ...
    const academicYearListUrl =
      "https://be-enterprise.herokuapp.com/v1.0/academicYear";
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/v1.0/academicYear', JSON.stringify(academic_year), {
                headers: {

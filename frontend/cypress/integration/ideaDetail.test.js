...
describe("Test existed elements", () => {
  beforeEach(() => {
    cy.visit(`${https://832a-14-226-238-211.ap.ngrok.io/v1.0}/ideas`);
  ...
  it("should show the first and second idea", () => {
    ...
    cy.url().should("eq", `${https://832a-14-226-238-211.ap.ngrok.io/v1.0}/ideas`);
  ...
  it("should test the + New Button and back", () => {
    ...
    cy.url().should("eq", `${https://832a-14-226-238-211.ap.ngrok.io/v1.0}/ideas/ideacreate`);
    cy.wait(2000);
    cy.xpath("//a[text()=' Back']").should("be.visible").click();
    cy.url().should("eq", `${https://832a-14-226-238-211.ap.ngrok.io/v1.0}/ideas`);
  });
